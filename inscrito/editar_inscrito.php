<?php 
	...
	if(isset($_SESSION['cd_login']) and !empty($_SESSION['cd_login'])){
		$cd = $_SESSION['cd_login'];
		$login = $_SESSION['cd_login'];
	

        $sql="SELECT * from tb_inscrito join tb_login on cd_login = id_login where id_login = $login";
            ...
            <div class="col s12">
                <div class="col s10 m8 l6 offset-s1 offset-m2 offset-l3 z-depth-2" style="background-color:white; border-radius: 10px;margin-top:50px;padding-bottom:20px;">
                    ...
                    <div class="corpo_box col s10 offset-s1">
                        <form action="/inscrito/actions/atualizar_inscrito.php" method="post">
