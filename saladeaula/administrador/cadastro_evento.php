...
<html style="user-select: none;">
    <head>
        <meta charset="utf-8">
        <title>Andorinha | Cadastro Evento</title>
            ...
            <div class="col s12">
                <div class="col s10 m8 l6 offset-s1 offset-m2 offset-l3 z-depth-2" style="background-color:white; border-radius: 10px;margin-top:50px;padding-bottom:20px;">
                    <div class="topo_box center center-align col s10 offset-s1">
                        <img src="/saladeaula/images/logo2.png" style="width: 100%; height: auto; cursor: pointer;" onclick="window.location = 'crud_evento.php';">
                    </div>
                    <div class="col s12 center center-align">
                        <h4 onclick="rodar();">Cadastrar Evento</h4>
                    </div>
                    <div class="corpo_box col s10 offset-s1">
                        <form action="../actions/cadastrar_evento.php" method="post">
                            <div class="input-field">
                                <i class="material-icons prefix">note_add</i>
                                <label for="nm_evento">Nome:</label>
                                <input type="text" name="nm_evento" id="nm_evento" required>
                            </div>
                             <div class="input-field">
                                <i class="material-icons prefix">note_add</i>
                                <label for="ds_evento">Descrição:</label>
                                <input type="text" name="ds_evento" id="ds_evento" required>
                            </div>
                            <div class="input-field">
                                <i class="material-icons prefix">border_color</i>
                                <label for="dt_evento">Data:</label>
                                 <input type="text" class="datepicker" name="dt_evento" id="dt_evento" required onfocus="document.getElementById('st_publico').focus();">
                            </div>
                             <div class="input-field">
                                <i class="material-icons prefix">border_color</i>
                                <label for="st_publico">Status para o público:</label>
                                <input type="text" name="st_publico" id="st_publico" required>
                            </div>
                            <div class="input-field">
                                <i class="material-icons prefix">border_color</i>
                                <select name="id_evento" required>
                                    <option disabled="disabled" selected >Selecione um administrador</option>
                                    <?php
