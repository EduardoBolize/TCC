...
<html style="user-select: none;">
    <head>
        <meta charset="utf-8">
        <title>Andorinha | Cadastrar Professor</title>
        	...
        	<div class="col s12">
        		<div class="col s10 m8 l6 offset-s1 offset-m2 offset-l3 z-depth-2" style="background-color:white; border-radius: 10px;margin-top:50px;padding-bottom:20px;">
        			<div class="topo_box center center-align col s10 offset-s1">
                        <img src="/saladeaula/images/logo2.png" style="width: 100%; height: auto; cursor:pointer;" onclick="window.location = '../administrador/crud_professor.php';">
                    </div>
                    <div class="col s12 center center-align">
                        <h4 onclick="rodar()">Cadastrar Professor</h4>
                    </div>
        			<div class="corpo_box col s10 offset-s1">
        				<form action="../actions/cadastrar_professor.php" method="post">
                            ...
                            <div class="input-field">
                                ...
                                <input type="text" name="nm_professor" id="nm_professor" required>
                            </div>
                            <div class="input-field">
                            ...
                            <div class="input-field">
                                ...
                                <input type="text" name="nr_telefone" id="nr_telefone" required pattern="\([0-9]{2}\)[\s][0-9]{4}-[0-9]{4,5}">
                            </div>
                            <div class="input-field">
