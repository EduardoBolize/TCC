...
<html>
    <head>
        <meta charset="utf-8">
        <title>Andorinha | Atividade</title>
    ...
    <body>
							...
							<div class="item_box col s12 m10 offset-m1">
								<div class="item_content">
									<div class="item_top col s12 center center-align">
										<h3>Atividade | Funções</h3>
									</div>
									<div class="item_bot col s12" style="padding-bottom:10px;padding-top: 10px;">
										<table>
											<thead>
												<tr>
													<th><a class="btn-floating waves-effect waves-light btn-small" href="cadastro_atividade.php"><i class="material-icons right">add</i>cadastrar</a></th>
													<th>Nome</th>
													<th>Descrição</th>
													<th>Status</th>
													<th>&nbsp;</th>
        ...
        <script type="text/javascript">
    	 	...
    	 	function muda_modal(nome,cd,status){
    	 		...
    	 		document.getElementById('href_modal').href = "../actions/inativar_atividade.php?cd="+cd;
    	 	}
        </script>
    </body>
</html>
