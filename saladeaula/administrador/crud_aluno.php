    ...
    <body>
    	...
    	<div id="modal1" class="modal">
			<div class="modal-content">
				<h4>Inativar Aluno?</h4>
				<p>Deseja realmente <span id="act_modal">Teste</span> o aluno <span id="nome_modal">Teste</span>? Você poderá reativá-lo se necessário!</p>
			</div>
							...
							<div class="item_box col s12 m10 offset-m1">
								<div class="item_content">
									<div class="item_top col s12 center center-align">
										<h3>Alunos | Funções</h3>
									</div>
									<div class="item_bot col s12" style="padding-bottom:10px;padding-top: 10px;">
										<table>
											<thead>
												<tr>
													<th><a class="btn-floating waves-effect waves-light btn-small" href="cadastro_matricula.php"><i class="material-icons right">add</i>cadastrar</a></th>
													<th>Nome</th>
													<th>E-mail</th>
													<th>Status</th>
													<th>&nbsp;</th>
											...
											<tbody>
												<?php
													...
													include_once('../functions/exibir_alunos.php');
													exibir_alunos(1);
