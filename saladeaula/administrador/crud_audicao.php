							...
							<div class="item_box col s12">
								<div class="item_content">
									<div class="item_top col s12 center center-align">
										<h3>Audição | Funções</h3>
									</div>
									<div class="item_bot col s12" style="padding-bottom:10px;padding-top: 10px;">
										<table>
											<thead>
												<tr>
													<th><a class="btn-floating waves-effect waves-light btn-small" href="cadastro_audicao.php"><i class="material-icons right">add</i>cadastrar</a></th>
													<th>Nome</th>
													<th>Descrição</th>
													<th>Data Abertura</th>
											...
											<tbody>
												<?php
													...
													include_once('../functions/exibir_audicao.php');
													exibir_audicao(1);
