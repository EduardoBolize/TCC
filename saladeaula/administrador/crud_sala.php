    ...
    <body>
    	...
    	<div id="modal1" class="modal">
			<div class="modal-content">
				<h4>Inativar Sala?</h4>
				<p>Deseja realmente <span id="status">Teste</span> o sala <span id="nome_modal">Teste</span>? Você poderá reativá-la se necessário!</p>
			</div>
								...
								<div class="item_content">
									...
									<div class="item_bot col s12" style="padding-bottom:10px;padding-top: 10px;">
										<table>
											<thead>
												<tr>
													<th><a class="btn-floating waves-effect waves-light btn-small" href="cadastro_sala.php"><i class="material-icons right">add</i>cadastrar</a></th>
													<th>Nome</th>
													<th>Sigla</th>
													<th>Curso</th>
													<th>Status</th>
        ...
        <script type="text/javascript">
    	 	...
    	 	function muda_modal(nome,cd,status){
    	 		...
    	 		document.getElementById('href_modal').href = "../actions/inativar_sala.php?cd="+cd;
    	 	}
        </script>
    </body>
</html>
