    ...
    <body>
    	...
    	<div id="modal1" class="modal">
			<div class="modal-content">
				<h4>Inativar turma?</h4>
				<p>Deseja realmente <span id="status">Teste</span> a turma <span id="nome_modal">Teste</span>? Você poderá reativá-la se necessário!</p>
			</div>
								...
								<div class="item_content">
									...
									<div class="item_bot col s12" style="padding-bottom:10px;padding-top: 10px;">
										<table>
											<thead>
												<tr>
													<th><a class="btn-floating waves-effect waves-light btn-small" href="cadastro_turma.php"><i class="material-icons right">add</i>cadastrar</a></th>
													<th>Sala</th>
													<th>Data</th>
													<th>Status</th>
													<th>&nbsp;</th>
