<?php 
    ...
    if(isset($_GET['cd']) and !empty($_GET['cd'])){
        ...
        redirect("Favor, escolha um professor para editar se quiser acessar essa página!","crud_professor.php");
    }

    $sql = "SELECT * from tb_professor join tb_login on id_login = cd_login where cd_professor = $cd";
    $query = $mysqli->query($sql);

    if($query->num_rows > 0){
        $row = $query->fetch_object();
    }else{
        redirect("O código desse professor é inválido!","crud_professor.php");
    }
?>
<!DOCTYPE html>
<html style="user-select: none;">
    <head>
        <meta charset="utf-8">
        <title>Andorinha | Atualizar Professor</title>
    ...
    <body>
        	...
        	<div class="col s12">
        		<div class="col s10 m8 l6 offset-s1 offset-m2 offset-l3 z-depth-2" style="background-color:white; border-radius: 10px;margin-top:50px;padding-bottom:20px;">
        			<div class="topo_box center center-align col s10 offset-s1">
                        <img src="/saladeaula/images/logo2.png" style="width: 100%; height: auto; cursor:pointer;" onclick="window.location = 'crud_professor.php';">
                    </div>
                    <div class="col s12 center center-align">
                        <h4 onclick="rodar()">Atualizar Professor</h4>
                    </div>
        			<div class="corpo_box col s10 offset-s1">
        				<form enctype="multipart/form-data" action="../actions/atualizar_professor.php" method="post">
        ...
        <script type="text/javascript">
            ...
            jQuery("#nr_data").mask("99/99/9999");
