    ...
    <body>
    	...
    	<div id="modal1" class="modal">
			<div class="modal-content">
				<h4>Inativar Evento?</h4>
				<p>Deseja realmente <span id="status">Teste</span> o evento <span id="nome_modal">Teste</span>? Você poderá reativá-lo se necessário!</p>
			</div>
							...
							<div class="item_box col s12 m10 offset-m1">
								<div class="item_content">
									<div class="item_top col s12 center center-align">
										<h3>Eventos | Funções</h3>
									</div>
									<div class="item_bot col s12" style="padding-bottom:10px;padding-top: 10px;">
										<table>
											<thead>
												<tr>
													<th><a class="btn-floating waves-effect waves-light btn-small" href="cadastro_evento.php"><i class="material-icons right">add</i>cadastrar</a></th>
													<th>Nome</th>
													<th>Data</th> 
													<th>Descrição</th>
													<th>Admin</th>
													<th>Status para o público</th>
													<th>Status</th>
													<th>&nbsp;</th>
													<th>&nbsp;</th>
												</tr>
											...
											<tbody>
												<?php
													...
													include_once('../functions/exibir_evento.php');
													exibir_evento(1);
        ...
        <script type="text/javascript">
    	 	...
    	 	function muda_modal(nome,cd,status){
    	 		...
    	 		document.getElementById('href_modal').href = "../actions/inativar_evento.php?cd="+cd;
    	 	}
        </script>
    </body>
</html>
