    ...
    <body>
    	...
    	<div id="modal1" class="modal">
			<div class="modal-content">
				<h4>Inativar Notícia?</h4>
				<p>Deseja realmente <span id="status">Teste</span> a notícia <span id="nome_modal">Teste</span>? Você poderá reativá-la se necessário!</p>
			</div>
							...
							<div class="item_box col s12 m10 offset-m1">
								<div class="item_content">
									<div class="item_top col s12 center center-align">
										<h3>Notícias | Funções</h3>
									</div>
									<div class="item_bot col s12" style="padding-bottom:10px;padding-top: 10px;">
										<table>
											<thead>
												<tr>
													<th><a class="btn-floating waves-effect waves-light btn-small" href="cadastro_noticia.php"><i class="material-icons right">add</i>cadastrar</a></th>
													<th>Título</th>
													<th>Descrição</th>
													<th>Data</th>
													<th>Admin</th>
											...
											<tbody>
												<?php
													...
													include_once('../functions/exibir_noticias.php');
													exibir_noticias(1);
        ...
        <script type="text/javascript">
    	 	...
    	 	function muda_modal(nome,cd,status){
    	 		...
    	 		document.getElementById('href_modal').href = "../actions/inativar_noticia.php?cd="+cd;
    	 	}
        </script>
    </body>
</html>
