    ...
    <body>
    	...
    	<div id="modal1" class="modal">
			<div class="modal-content">
				<h4>Inativar Curso?</h4>
				<p>Deseja realmente <span id="status">Teste</span> o curso <span id="nome_modal">Teste</span>? Você poderá reativá-lo se necessário!</p>
			</div>
							...
							<div class="item_box col s12 m10 offset-m1">
								<div class="item_content">
									<div class="item_top col s12 center center-align">
										<h3>Cursos | Funções</h3>
									</div>
									<div class="item_bot col s12" style="padding-bottom:10px;padding-top: 10px;">
										<table>
											<thead>
												<tr>
													<th><a class="btn-floating waves-effect waves-light btn-small" href="cadastro_curso.php"><i class="material-icons right">add</i>cadastrar</a></th>
													<th>Nome</th>
													<th>Descrição</th>
													<th>Status</th>
													<th>&nbsp;</th>
