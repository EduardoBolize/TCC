<?php 
	...
	$sql = "SELECT cd_tarefa, id_atividade, nm_atividade, id_turma,nm_sala, dt_turma from tb_tarefa join tb_atividade on id_atividade = cd_atividade join tb_turma on id_turma = cd_turma JOIN tb_sala on id_sala = cd_sala";
				...
				<div class="col s10 m8 l6 offset-s1 offset-m2 offset-l3 z-depth-2" style="background-color:white; border-radius: 10px;margin-top:50px;padding-bottom:20px;">
					...
					<div class="corpo_box col s10 offset-s1">
						<form action="../actions/atualizar_tarefa.php" method="post">
							<input type="hidden" name="cd_tarefa" value="<?php echo $row->cd_tarefa; ?>">
							...
							<div class="input-field">
								...
								<input type="text" class="datepicker" name="dt_tarefa" id="dt_tarefa" required onfocus="document.getElementById('id_atividade').focus();" value="<?php echo $row->dt_tarefa; ?>">
							</div>
							<div class="input-field">
								<i class="material-icons prefix">today</i>
								<label for="dt_prazo">Data Prazo:</label>
								<input type="text" class="datepicker" name="dt_prazo" id="dt_prazo" required onfocus="document.getElementById('id_atividade').focus();" value="<?php echo $row->dt_prazo; ?>">
							</div>
							<div class="input-field">
								<i class="material-icons prefix">border_color</i>
								<label for="hr_prazo">Hora Prazo:</label>
								<input type="text" class="timepicker" name="hr_prazo" id="hr_prazo" required onfocus="document.getElementById('id_atividade').focus();"  value="<?php echo $row->hr_prazo; ?>">
							</div>
