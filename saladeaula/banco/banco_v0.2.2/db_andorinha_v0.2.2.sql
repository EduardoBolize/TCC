...
create table tb_inscrito_audicao(
    cd_inscrito_audicao int not null auto_increment,
    ...
    foreign key(id_inscrito) references tb_inscrito(cd_inscrito),
...
create table tb_tarefa(
    ...
    foreign key(id_turma) references tb_turma(cd_turma),
    foreign key(id_criador) references tb_login(cd_login)
)DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;

create table tb_tarefa_materia(
	cd_tarefa_materia int not null auto_increment,
...
create table tb_turma_matricula(
    ...
    st_turma_matricula boolean not null default 1,
    id_matricula int not null,
    id_turma int not null,
...
insert into tb_arquivo values (null,"user.png",1);

insert into tb_admin values (null,'Administrador',1,1,1);

insert into tb_arquivo values (null,"padrao.jpg",1);

insert into tb_curso values
	(null,'Ballet Clássico Formativo','Curso voltado a formação profissionalização dos bailarinos',2,'1'),
	(null,'Ballet Clássico Não Formativo','Curso voltado a prática do Ballet sem objetivo inicial de formação, visando a melhora da qualidade de vida',2,'1'),
	(null,'Modalidades Livres','Explora diferentes possibilidades de movimento, estilos de dança e rítmos musicais',2,'1'),
	(null,'Zumba Dance','Dança voltada à queima de calorias em massa, ideal para todas as idades!',2,'1'),
	(null,'Desenvolvimento Artístico','Formação dos alunos em vários campos da arte, como a dança, a música e o teatro',2,'1'),
	(null,'Street Dance','Dança que aborda estilos como o Rap, o Hip-Hop entre outros',2,'1');
...
(null, 'Giulia Souza', 1, '123.456.789-01', '(13) 8186-1521', '(13) 8112-1731', 'Rua das Amoreiras 1345', 'Peruíbe', 'giulia@andorinha.com', '1', '1', 100),
(null, 'Nathalie Castro', 1, '123.456.789-02', '(13) 8186-1522', '(13) 8112-1732', 'Rua das Amoreiras 1345', 'Peruíbe', 'nath@andorinha.com', '1', '1', 101),
(null, 'Junior Castro', 1, '123.456.789-03', '(13) 8186-1523', '(13) 8112-1733', 'Rua das Amoreiras 1345', 'Peruíbe', 'junior@andorinha.com', '1', '1', 102),
(null, 'Fernando Augusto', 1, '123.456.789-04', '(13) 8186-1524', '(13) 8112-1734', 'Rua das Amoreiras 1345', 'Peruíbe', 'fernando@andorinha.com', '1', '1', 103),
(null, 'Michelle Barbosa', 1, '123.456.789-05', '(13) 8186-1525', '(13) 8112-1735', 'Rua das Amoreiras 1345', 'Peruíbe', 'michelle@etec.com', '1', '1', 104),
(null, 'Joelma Sartori', 1, '123.456.789-06', '(13) 8186-1526', '(13) 8112-1736', 'Rua das Amoreiras 1345', 'Peruíbe', 'joelma@etec.com', '1', '1', 105);
