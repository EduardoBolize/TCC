                    ...
                    <div class="corpo_box col s10 offset-s1">
                        <form action="../actions/cadastrar_atividade.php" method="post">
                            ...
                            <div class="input-field">
                                ...
                                <label for="dt_atividade">Data Inicial:</label>
                                <input type="text" class="datepicker" name="dt_atividade" id="dt_atividade" required onfocus="document.getElementById('id_atividade').focus();">
                            </div>
                            <div class="input-field">
                                <i class="material-icons prefix">today</i>
